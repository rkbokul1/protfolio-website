        ...
        <div className='px-12 text-white'>
            <div class="hero min-h-screen">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    <img src="https://placeimg.com/260/400/arch" class="min-w-sm rounded-lg shadow-2xl" alt='rkbokul'/>
                    <div>
                        ...
                        <button class="btn btn-outline text-white">Download Resume</button>
                    </div>
                </div>
            </div>
        </div>
